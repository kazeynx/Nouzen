...
module.exports = async (client, message) => {
    ...
    if (message.mentions.has(client.user) && !message.mentions.everyone && message.mentions.roles.size === 0) {
        ...
        //message.channel.send(`https://cdn.discordapp.com/attachments/1322940109036851282/1331663370507653120/standard_6.gif?ex=67985e68&is=67970ce8&hm=09abdd1c9d914f1f4b900844e29677244e2bf4f0d037c81c3b39797ef3cdfefd&`)
    ...
    <a:1968myaowlcatpeek:1333419214505250827>Nouzen is an existence that helps you make your server more automatic by simplifying tasks, managing roles, moderating chats, and providing seamless integration of powerful features <a:10107melodysmart:1333422941848862740>. With Nouzen, you can create a highly efficient and engaging environment for your community, ensuring that everything runs smoothly while you focus on building connections and growing your server <a:gura:1333393351730528287>. 
    ...
    ### **✮*•̩̩͙✧•̩̩͙*˚✧*˚〔<a:5565cloud:1333420883984908329>｜DEVELOPER｜<a:5565cloud:1333420883984908329>〕˚*✧˚*•̩̩͙✧•̩̩͙*˚✮**
    
    <a:52563totoropeeking:1333424335544647710> Hey there! I’m Kazeynx, the mind behind Nouzen <a:2356luffy24:1333419403538202656>. Every line of code was built with dedication to help you master your server effortlessly <a:3683girlsleep:1333419908834398219>. Got ideas or noticed something off? Share them with me <a:39554katherinespinunreliable:1333423934049226803>. Together, we’ll push Nouzen to new heights—because perfection is always within reach <a:8276pepecaught:1333422120637562942>.
...
╩═══════════════════════════════════════════╩\`\`\`
    ...
    〔<a:DIAMOND:1034743982216990730>〕Bot Status : **Online <a:uptime:1333386432018124850> (${time})**
    〔<a:setting:1324015494768103556>〕Bot Version : **v${packageJson.version}**
    〔<a:99609calendar:1333425836853952622>〕Bot Uptime : **${formatUptime(client.uptime)}**
    ...
    <a:59754gojocatvibe:1333424555124985947> Ready to unlock Nouzen’s magic? Type \`/help\` and discover all the commands, or click the \`selection panel\` and feel the power at your fingertips <a:9114skillissuepeepo:1333422371562061898>. The possibilities are limitless—let's elevate your server to new heights, effortlessly <a:4969myaowlcatnod:1333420589091651624>.
    `)
          .setImage(`https://cdn.discordapp.com/attachments/1322940109036851282/1331663370507653120/standard_6.gif?ex=67985e68&is=67970ce8&hm=09abdd1c9d914f1f4b900844e29677244e2bf4f0d037c81c3b39797ef3cdfefd&`)
          .setTimestamp()
        ...
        const row1 = new ActionRowBuilder()
          .addComponents(
            new StringSelectMenuBuilder()
              ...
              .setPlaceholder('What’s your next move?')
              .addOptions([
                {
                  label: 'Commands',
                  description: 'Discover all the tools you need to make your server thrive.',
