...
module.exports = async (interaction, pages, time = 30 * 1000) => {
    ...
    try {
        if (!interaction || !pages || !pages > 0) throw new Error('[PAGINATION] Invalid rags');
        ...
        .setEmoji('<a:arrowleft:1342003780102656001>')
        .setStyle(ButtonStyle.Primary)
        .setDisabled(true);
        ...
        .setEmoji('<a:arrowright:1342003791125282866>')
        .setStyle(ButtonStyle.Primary);

        const last = new ButtonBuilder()
        .setCustomId('pagelast')
        .setEmoji('<a:arrow:1333117123697971220>')
        .setStyle(ButtonStyle.Primary);
